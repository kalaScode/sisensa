...
<div class="w-full mx-auto px-4 sm:px-6 lg:px-36">
    <div class="w-full mx-auto px-4 sm:px-100 py-12 max-w-lg">
        <div class="bg-white rounded-lg border-2 border-gray-300 p-6 shadow-lg">
            <!-- Toggle Presensi -->
            <div class="mb-6">
                <label for="presenceType" class="block text-sm font-medium text-gray-700 mb-2">Jenis Presensi</label>
                <div class="relative">
                    <select id="presenceType" class="block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md bg-gray-100">
...
<script>
    window.onload = async function () {
        ...
        function updateUI() {
            ...
            if (presenceType === "office" && !isWithinRange) messages.push("Jarak harus dalam radius 100 meter");

...
<main class="max-w-7xl mx-auto sm:px-6 lg:px-36 py-10">
    <div class="max-w-7xl mx-auto px-4 flex justify-center">
        <h1 class="text-3xl font-bold text-[#122036] text-center">Riwayat Karyawan</h1>
    </div>

    <!-- Menu Tabs -->
    <div class="flex border-b border-gray-200 mb-4">
        <a href="#" class="px-4 py-2 text-sm font-medium text-gray-700 border-b-2 border-black tab-link"
            data-tab="presensi">
            Presensi
        </a>
        <a href="#" class="px-4 py-2 text-sm font-medium text-gray-700 border-b-2 border-black tab-link"
    ...
    <div class="tab-content">
        ...
        <div id="presensi" class="tab-pane">
            ...
            <div class="flex flex-wrap items-center justify-between space-y-4 mb-4">
                ...
                <!-- Search Field -->
                <div class="relative">
                    <input type="text" id="cariPresensi" placeholder="Cari..."
                        class="w-full pl-10 pr-3 py-2 text-sm border-2 border-custom rounded-lg focus:outline-none focus:border-custom" />
            ...
            <div class="mt-8 flex justify-end">
                <nav class="flex items-center space-x-2">
                    <button
                        class="px-4 py-2 border-2 border-[#122036] text-[#122036] rounded-lg hover:bg-custom hover:text-white hover:border-custom">
                        <i class="fas fa-chevron-left mr-2"></i>
                        Sebelumnya
                    </button>
                    <button class="px-4 py-2 bg-custom border-2 border-custom text-white rounded-lg">1</button>
                    <button
                        class="px-4 py-2 border-2 border-[#122036] text-[#122036] rounded-lg hover:bg-custom hover:text-white hover:border-custom">2</button>
                    <button
                        class="px-4 py-2 border-2 border-[#122036] text-[#122036] rounded-lg hover:bg-custom hover:text-white hover:border-custom">3</button>
                    <button
                        class="px-4 py-2 border-2 border-[#122036] text-[#122036] rounded-lg hover:bg-custom hover:text-white hover:border-custom">
                        Selanjutnya
                            ...
                            <div>
                                ...
                                <div id="lastDaysdropdown"
                                    ...
                                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                        ...
                                        <li>
                                            <a href="#"
                                                class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Tahunan</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="flex-col items-center">
                                <div>
                                    <button id="dropdownDefaultButton" data-dropdown-toggle="tahundropdown"
                                        data-dropdown-placement="bottom" type="button"
                                        class="px-3 py-2 inline-flex items-center text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">2024<svg
                                            class="w-2.5 h-2.5 ms-2.5" aria-hidden="true"
                                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
    ...
    <div class="flex justify-between space-x-4 mt-8" id="button-container">
        <button type="button"
            class="!rounded-button w-1/3 bg-gray-200 text-gray-700 px-4 py-2 font-semibold hover:bg-gray-300 transition-all"
...
<script>
    document.querySelectorAll('.tab-link').forEach((tabLink) => {
        tabLink.addEventListener('click', (e) => {
            ...
            // Reset active tabs
            document.querySelectorAll('.tab-link').forEach(link => link.classList.remove('border-black',
                'text-gray-700'));

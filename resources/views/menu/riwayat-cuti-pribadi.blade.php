            ...
            <div class="p-6">
                <div class="relative mb-6">
                    <div class="flex flex-wrap items-center gap-4 mb-6">
                        <form action="{{ route('riwayat-cuti-pribadi') }}" method="GET"
                            ...
                            <div>
                                ...
                                <select name="jenis" id="bagian"
                                    ...
                                    style="min-width: 150px;">
                                    <option value="">Semua</option>
                                    <option value="cuti" {{ request('jenis') == 'cuti' ? 'selected' : '' }}>Cuti
                                    </option>
                            ...
                            <div class="flex flex-col items-start">
                                ...
                                <div class="flex items-center gap-2 mt-2 w-full">
                                    ...
                                    <!-- Reset Button -->
                                    <a href="{{ route('riwayat-cuti-pribadi') }}"
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach ($cuti as $item)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div
                                                    class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ $item->jenis_Cuti == 'Cuti' ? 'bg-blue-100 text-blue-800' : 'bg-orange-100 text-orange-800' }}">
                                                    {{ $item->jenis_Cuti }}</div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <span
                                                    class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full
                                                    @if ($item->status_Cuti == 'Disetujui') bg-green-100 text-green-800
